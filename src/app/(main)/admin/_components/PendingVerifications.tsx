...
import verifyConsultant from "../_api/verifyConsultants";
                ...
                <Dialog>
                  ...
                  <DialogContent className="md:w-[780px]">
                    ...
                    <div className="flex flex-col md:flex-row justify-between">
                      ...
                      <div>
                        <h3 className="text-sm font-bold">Application Date</h3>
                    ...
                    <Separator />
                    <div>
                      <h4 className="text-sm font-bold">service Description</h4>
